...
% Last Modified by GUIDE v2.5 18-Jan-2016 18:08:10
...
if (checkM8195A)
    arbConfig = loadArbConfig();
    if (~strcmp(arbConfig.model, 'M8195A_1ch') && ~strcmp(arbConfig.model, 'M8195A_2ch') && ~strcmp(arbConfig.model, 'M8195A_4ch'))
...
switch (fct)
    case 'code' % generate MATLAB code
        ...
        s = sprintf(['[s, fs, nSym, nSamples] = iserial(''dataRate'', %g, ''sampleRate'', %g, ...\n' ...
            ...
            amplitude, dutyCycle / 100, correction, downloadStr);
        fs = 0;
        dataRate = 0;
...
% Hints: contents = cellstr(get(hObject,'String')) returns popupmenuDataFormat contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenuDataFormat

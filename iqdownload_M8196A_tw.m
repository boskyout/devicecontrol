...
% THIS SOFTWARE MAY ONLY BE USED IN CONJUNCTION WITH KEYSIGHT INSTRUMENTS. 
    ...
    f = instrfind('Type', 'visa-tcpip', 'RsrcName', RsrcName, 'Tag', '');
    if isempty(f)
        f = visa('agilent', RsrcName);
    else
        fclose(f);
        f = f(1);
    end
    
    f.OutputBufferSize = 1e6;
    f.InputBufferSize = 1e6;

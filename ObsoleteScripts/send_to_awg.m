function result = send_to_awg(data,fs,arbConfig,skew,flagCor,run)
marker1 = [];
marker2 = [];
segmNum = 1; % default: 1
...
result = iqdownload_M8195A_tw(arbConfig, fs, data, marker1, marker2, segmNum, channelMapping, run);